            ...
            <div class="left">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"
                           placeholder=" <?php echo($this->lang->line('ph firstname')) ?>" name="firstname" required=""
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"
                           placeholder=" <?php echo($this->lang->line('ph lastname')) ?>" name="lastname" required=""
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" autocomplete="username"
                           placeholder=" <?php echo($this->lang->line('ph email')) ?>" name="email" required=""
            ...
            <div class="right">
                ...
                <div class="form-group ">
                    ...
                    <input type="password" class="form-control" autocomplete="current-password"
                           placeholder=" <?php echo($this->lang->line('ph confirm password')) ?>" name="conf_password"
                           required="">
                ...
                <div class="form-group" id="submitButtons">
                    <input type="submit" name="regisSubmit" class="btn-primary"
                           value=" <?php echo($this->lang->line('register')) ?>"/>
...
<script>
    $(function () {
        ...
        for (const key of Object.keys(nursingHomes)) {
            $('.nursingHomes').append($('<option>', {
                value: nursingHomes[key]["NursingHomeID"],
                text: nursingHomes[key]["name"]
            }));
        }
    })
</script>
